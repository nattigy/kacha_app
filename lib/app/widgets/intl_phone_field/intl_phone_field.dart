...
class _IntlPhoneFieldState extends State<IntlPhoneField> {
  ...
  Widget build(BuildContext context) {
    return TextFormField(
      ...
      // validator: (value) {
      //   // if (value == null) return "phone number is empty";
      //   // if (!isNumeric(value) && value.isNotEmptyAndNotNull)
      //   //   return "phone number can only be numeric values";
      //   if (value == null || !isNumeric(value)) return FormValidator.validatePhone(value);
      //   // if (!widget.disableLengthCheck) {
      //   return value.length >= _selectedCountry.minLength &&
      //           value.length <= _selectedCountry.maxLength
      //       ? FormValidator.validatePhone(value)
      //       : "Phone number length too short";
      //   // }
